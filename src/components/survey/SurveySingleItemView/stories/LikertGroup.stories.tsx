          ...
          key: 'rg', role: 'responseGroup', items: [
            {
              key: 'lg', role: 'likertGroup', items: [
                { key: 't1', role: 'text', content: [{ code: 'en', resolvedText: 'Example 1' }], style: [{ key: "className", value: "mb-2 fw-bold sticky-top bg-grey-1" }, { key: "variant", value: "h6" }] },
                {
                  key: 'l1', role: 'likert',
                  items: [
                ...
                { key: 't2', role: 'text', content: [{ code: 'en', resolvedText: 'Example 2: stacked on small screen' }], style: [{ key: "className", value: "mb-2 fw-bold sticky-top bg-grey-1" }, { key: "variant", value: "h6" }] },
                {
                  key: 'l2', role: 'likert',
                  style: [{ key: "responsive", value: "stackOnSmallScreen" }],
                  items: [
                    { key: '1', role: 'option', content: [{ code: 'en', resolvedText: 'with Text 1' }] },
                    { key: '2', role: 'option', content: [{ code: 'en', resolvedText: 'with Text 2' }] },
                    { key: '3', role: 'option', content: [{ code: 'en', resolvedText: 'with Text 3 Long label to see what happens' }] },
