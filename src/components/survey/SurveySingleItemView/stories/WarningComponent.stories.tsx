...
export default {
  title: "Survey Item Types/Warning Component"
};
...
export const Example = () => <SurveySingleItemView
  renderItem={{
    ...
    components: {
      ...
      role: 'root',
      items: [
        { key: 't1', role: 'warning', content: [{ code: 'en', resolvedText: 'Warning Component Example' }] },
        { key: 't2', role: 'warning', content: [{ code: 'en', resolvedText: 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.' }] },
      ]
    }
  }}
